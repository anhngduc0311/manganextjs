...
export function ReaderView({
  ...
  // Prefetch adjacent chapters via Next.js router
  useEffect(() => {
    if (nextChapterNumber !== null && nextChapterNumber !== undefined) {
      router.prefetch(`/comics/${comicSlug}/chuong-${nextChapterNumber}`);
    }
    if (prevChapterNumber !== null && prevChapterNumber !== undefined) {
      router.prefetch(`/comics/${comicSlug}/chuong-${prevChapterNumber}`);
    }
  }, [router, comicSlug, nextChapterNumber, prevChapterNumber]);
